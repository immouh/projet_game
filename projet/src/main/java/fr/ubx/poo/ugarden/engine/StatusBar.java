...
public class StatusBar {
    ...
    public StatusBar(Game game, Group root, int sceneWidth, int sceneHeight) {
        ...
        level.getChildren().add(new ImageView(ImageResourceFactory.getInstance().getDigit(game.world().currentLevel())));
    ...
    public void update(Game game) {
        ...
        lives.setText(String.format("%d", game.getPlayer().getLives()));
        keys.setText(String.format("%d", game.getPlayer().getKeys()));
        energy.setText(String.format("%d", game.getPlayer().getEnergy()));
        diseaseLevel.setText(String.format("%d", game.getPlayer().getPApples()));
    }
